...
public class SelectAllByDay implements IPartialRequestFactory<Connection,ResultSet> {
private final String sqlString;
private final String table;
private final String date;

public SelectAllByDay(String sqlString, String table, String date)
        {
